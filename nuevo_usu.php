    ...
    <!-- Navigation -->
        ...
        <form name="form1" action="valida.php" enctype="multipart/form-data" method="post">
            <table border="0" width="400" align="center">
                <tr>
                    <td>1er Nombre: </td>
                    <td><input type="text" name="txt1no" required="" placeholder="Nombre"></td>
                </tr><tr>
                    <td>2do Nombre: </td>
                    <td><input type="text" name="txt2no" required="" placeholder="Nombre"></td>
                </tr><tr>
                    <td>1er Apellido: </td>
                    <td><input type="text" name="txt1ap" required="" placeholder="Apellido"></td>
                </tr><tr>
                    <td>2do Apellido: </td>
                    <td><input type="text" name="txt2ap" required="" placeholder="Apellido"></td>
                </tr><tr>
                    <td>Telefono: </td>
                    <td><input type="text" name="txtTel" required="" placeholder="Telefono"></td>
                </tr><tr>
                    <td>Celular: </td>
                    <td><input type="text" name="txtCel" required="" placeholder="Celular"></td>
                </tr><tr>
                    <td>Correo: </td>
                    <td><input type="text" name="txtMail" required="" placeholder="ejemplo@gmail.com"></td>
                </tr><tr>
                    <td>Contraseña: </td>
                    <td><input type="password" name="txtPas" required="" placeholder="Contraseña"></td>
                </tr><tr>
                    <td>Tipo: </td>
                    <td><input type="text" name="txtTip" required="" placeholder="Admin-User"></td>
                </tr><tr>
                    <th colspan="2">
                        <input type="submit" name="btn" value="Grabar Registro"></th>
                </tr>
            </table>
            <input type="hidden" name="accion" value="insertar_usu">
        </form>
