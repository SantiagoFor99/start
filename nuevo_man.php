        ...
        <h2 align="center">Editar Registro</h2>
         <form name="form1" action="valida.php" method="post">
            ...
            { 
                ...
                <tr>
                    <td>Id Usuario: </td>
                    <td><input type="text" name="txtcod" value="<?php echo $row[0]; ?>"></td>
                </tr><tr>
                    <td>Caracteristicas Disco Duro: </td>
                    <td><input type="text" name="txthdd" placeholder="Marca, Espacio"></td>
                </tr><tr>
                    <td>Cantidad de Memorias: </td>
                    <td><input type="text" name="txtcme" placeholder="1,2,3....."></td>
                </tr><tr>
                    <td>Caracteristicas de las Memorias: </td>
                    <td><input type="text" name="txtcam" placeholder="ddr, gb/mb"></td>
                </tr><tr>
                    <td>Procesador: </td>
                    <td><input type="text" name="txtcpu" placeholder="Intel/Amd"></td>
                </tr><tr>
                    <td>Cargador: </td>
                    <td><input type="text" name="txtcar" placeholder="Si/No"></td>
                </tr><tr>
                    <td>Marca Equipo: </td><td>
                    <select name="txtmar">
                    ...
                    <td><input type="text" name="txtabo" placeholder="Abono"></td>
                </tr><tr>
                    <td>Total a Pagar: </td>
                    <td><input type="text" name="txtpre" placeholder="Precio"></td>
                </tr><tr>
                    <td>Tipo de Equipo: </td>
                    <td><input type="text" name="txttie" placeholder="Laptop, Tablet...."></td>
                </tr><tr>
                    <td>Observación Daños y/o Raspones: </td>
                    <td><input type="text" name="txtdan" placeholder="Disco malo"></td>
                </tr><tr>
                    <th colspan="2">
            ...
            <input type="hidden" name="accion" value="insertar_man">
        </form>
