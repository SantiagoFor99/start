    ...
    <!-- Portfolio Grid Section -->
        ...
        $cod=$_REQUEST['cod'];
         $cnx=new PDO("mysql:host=localhost;dbname=local","root","");
            $res = $cnx->query("select * from productos where id_producto=$cod");
        ?>
         ...
         <form name="form1" action="valida.php" method="post">
                             ...
                             foreach ($res as $row)
            {
                ...
                <tr>
                    ...
                    <td>Descripcion: </td>
                    <td><input type="text" name="txtDes" required="" value="<?php echo $row[1]; ?>"></td>
                </tr><tr>
                    <td>Id_categoria: </td>
                    <td><select name="txtCan">
					<option value="<?php echo $row[2]; ?>">Seleccionar por categoria</option>
                    ...
                    <td>Precio: </td>
                    <td><input type="text" name="txtPre" required="" value="<?php echo $row[3]; ?>"></td>
                </tr><tr>
                    <td>Ultima Actualizacion: </td>
                    <td><input type="text" name="txtUlt" required="" value="<?php echo $row[4]; ?>"></td>
                </tr><tr>
                    <td>Nombre imagen: </td>
                    <td><input type="text" name="txtImg" required="" value="<?php echo $row[5]; ?>"></td>
                </tr><tr>
                    <th colspan="2">
            ...
            <input type="hidden" name="accion" value="editar_pro">
        </form>
	<!-- About Section -->
