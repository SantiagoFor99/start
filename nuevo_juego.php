...
<html>
  ...
  <body id="page-top">
    ...
    <!-- Portfolio Grid Section -->
		...
		<h2 align="center">Nuevos Videojuegos</h2>
        <form name="form1" action="valida.php" enctype="multipart/form-data" method="post">
            <table border="0" width="400" align="center">
                <tr>
                    <td>Nombre: </td>
                    <td><input type="text" name="txtJue" required="" placeholder="Detalles,nombre o cualidades"></td>
                </tr><tr>
                    <td>Cantidad: </td>
                    <td><input type="text" name="txtCan" required="" placeholder="Cantidad"></td>
                </tr><tr>
					<td>Consola: </td>
            ...
            <input type="hidden" name="accion" value="insertar_juego">
        </form>
